export const state={user:null,route:'landing',theme:localStorage.getItem('mindvault_theme')||'dark',notes:[],files:[],ideas:[],productivity:{todos:[],reminders:[],focus:'',pomodoro:{work:25,break:5}},stats:{},activity:[],searchResults:[]};
